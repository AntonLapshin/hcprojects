...
-- Generated 23-май-2012 10:35:16 from RMSPRD@RMSP

create
PACKAGE y_assortment_check
/* Formatted on 24-апр-2012 12:10:44 (QP5 v5.126) */
is
    procedure local_just_one_regionwh (i_id_doc          in     number,
                                       o_result             out number,
    ...
    procedure global_price_specification (i_id_doc          in     number,
                                          o_result             out number,
                                          o_error_message      out varchar2);
    ...
    --<Metelkov A. 15-05-2012 http://jira.hc/browse/AM-26
    procedure global_just_one_regionwh (i_id_doc          in     number,
                                       o_result             out number,
                                       o_error_message      out varchar2);

    procedure global_wh_rest_exists (i_id_doc          in     number,
                                     o_result             out number,
                                     o_error_message      out varchar2);
...
-- Generated 23-май-2012 10:35:17 from RMSPRD@RMSP

create
PACKAGE y_assortment_completion
/* Formatted on 7-фев-2012 15:15:53 (QP5 v5.126) */
is
    /*
...
*/
    ...
    -- Method uploads docs A OPERATIVE (FORCE)
    function assortment_set_force (o_error_message in out varchar2)
        return boolean;
/*
    -- Method uploads doc by id (NORMAL)
    function assortment_set_doc_normal (i_id_doc          in     number,
                                        o_error_message   in out varchar2)
        return boolean;
*/
    -- Method uploads user's docs (NORMAL)
    function assortment_set_user_normal (i_id_user         in     varchar2,
                                        o_error_message   in out varchar2)
        return boolean;
/*
    -- Method uploads docs R REGULAR (NORMAL)
    function assortment_set_normal (o_error_message in out varchar2)
        return boolean;
*/
    -- Method uploads user's docs R REGULAR (NORMAL)
    function assortment_set_users (o_error_message in out varchar2)
        return boolean;
/*
...
/* Formatted on 27.02.2012 10:52:16 (QP5 v5.126) */
is
