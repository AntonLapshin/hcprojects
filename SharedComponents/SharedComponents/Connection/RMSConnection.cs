...
namespace SharedComponents.Connection
{
    public class RMSConnection
    {
        public static RMSConnection RMSP = new RMSConnection
                                            {
                                                SID = "rmsp",
                                                Hosts =
                                                    new List<Host>
        ...
        public static RMSConnection RMSTST = new RMSConnection
                                              {
                                                  SID = "rmstst",
                                                  Hosts =
                                                      new List<Host>
        ...
        public static RMSConnection RMSTSTN = new RMSConnection
                                               {
                                                   SID = "rmsp",
                                                   Hosts =
                                                       new List<Host>
        ...
        public static RMSConnection Current { get; set; }
